...
var Hamilton = PsyTest{
	typeT:      "anxiety",
	nameT:      "hamilton",
	numberQ:    14,
	questions:  questionsHamilton,
	pointTest:  pointHamilton,
	keyboard:   hamiltonSymptomsKeyboard,
	resultTest: resultHamilton,
}

var questionsHamilton []string = []string{
...
var pointHamilton = map[string]int{
	"В слабой степени":        1,
